    ...
    <div className={s.services}>
        ...
        <div className={s.info}>
            ...
            <p>Մեր Սերվիս կենտրոնում աշխատում են միայն փորձառու և վերապատրաստված մասնագետներ։
                Սերվիս կենտրոնը հագեցած է նորագույն սարքավորումներով և բարձրակարգ պահեստամասերով,
                որոնք կապահովեն Ձեր սարքավորումների անթերի աշխատանքը</p>
        </div>
        <div className={s.info}>
            <p> Սերվիս կենտրոնը իրականացնում է բջջային հեռախոսների և պլանշետների ախտորոշում և 
                վերանորոգում՝ սեղմ ժամկետներում և մատչելի գներով:Տրվում է նաև երաշխիք ցանկացած 
                տեսակի վերանորոգման համար:</p>
